...
public class Agenda extends JFrame {
    ...
    private void montaJanela() {        
        ...
        JButton botaoAdicionar = new JButton(new ImageIcon(requireNonNull(getClass().getResource(ICONE_ADICIONA))));
        JButton botaoRemover = new JButton(new ImageIcon(requireNonNull(getClass().getResource(ICONE_REMOVE))));
        ...
        Thread thread1 = new Thread((Runnable) listaContatos);
        thread1.start();

        Thread thread2 = new Thread((Runnable) campoNome);
        thread2.start();

        Thread thread3 = new Thread((Runnable) campoDetalhes);
        thread3.start();
